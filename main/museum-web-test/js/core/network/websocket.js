...
export class WebSocketHandler {
    ...
    handleTextMessage(message) {
        if (message.type === 'hello') {
            ...
            this._startListening(message.session_id);
    ...
    handleMCPMessage(message) {
        ...
        if (payload.method === 'tools/list') {
            ...
            if (visionConfig && typeof visionConfig === 'object' && visionConfig.url && visionConfig.token) {
                ...
                localStorage.setItem('museum_web_test_vision', visionConfigStr);
                if (visionUrl) visionUrl.value = visionConfig.url;
            } else {
                localStorage.removeItem('museum_web_test_vision');
