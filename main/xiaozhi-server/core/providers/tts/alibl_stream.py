...
class TTSProvider(TTSProviderBase):
    ...
    def __init__(self, config, delete_audio_file):
        ...
        if not self.api_key:
            raise ValueError("api_key is required for AliBL TTS")
        ...
        self.voice = config.get("voice", "Stella")  # 默认音色
    ...
    def _build_synthesis_parameters(self):
        parameters = {
            "text_type": "PlainText",
            "voice": self.voice,
            "format": self.format,
        ...
        if self.optimize_instructions is not None:
            parameters["optimize_instructions"] = self.optimize_instructions
        return parameters
        ...
        try:
            ...
            run_task_message = {
                ...
                "payload": {
                    ...
                    "model": self.model,
                    "parameters": self._build_synthesis_parameters(),
                    "input": {}
                },
            }
